...
use.page = {
    ...
    putWebsiteOffline: function () {
        ...
        n.rename(path.join(NSCore.use('NSSettings').STRUCTURE.server.root, '_maintenance.html'), path.join(NSCore.use('NSSettings').STRUCTURE.server.root, 'maintenance.html'), function (err) {
            console.log(err, 1);
            n.end();
