...
use.page = {
    main: function () {
        this.fetchSiteloadData('3dpthings.com', function (data) {
            let datasetA = {};
            let datasetB = {
                "Jan": 0,
                "Feb": 0,
            ...
            data.forEach(function (rec) {
                if (rec['PageID'].indexOf('?') > -1)
                    rec['PageID'] = rec['PageID'].split('?')[0];
    ...
    fetchSiteloadData: function (siteRef, cb) {
        ...
        let options = { method: 'GET',
            url: `http://darylcecile.net/api/performance/index.php?siteRef=${siteRef}` };
    ...
    buildChartA: function (datavalues) {
        let data = {
    ...
    buildChartB: function (datavalues) {
        let data = {
            labels: Object.keys(datavalues),
            datasets: [{
    ...
    buildChartC: function (datavalues) {
        let data = {
            labels: Object.keys(datavalues),
            datasets: [{
                    label: "Sessions",
